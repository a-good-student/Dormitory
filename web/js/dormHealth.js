...
$(function (){
    ...
    document.getElementById('suit').onclick=function (){
        ...
        var dormId=p[0].value, dormName=p[1].value, dormHealth=p[2].value, createTime=p[3].value, updateTime=p[4].value;
        $.ajax("/Dormitory/addHealth", {
            type:"post",
            dataType:"json",
            data:{dormId:dormId,dormName:dormName,dormHealth:dormHealth,createTime:createTime,updateTime:updateTime},
            // 请求成功后的回调函数。
...
function modifyHealth(obj){
    ...
    var dormId=p[0].value, dormName=p[1].value, dormHealth=p[2].value, createTime=p[3].value, updateTime=p[4].value;
    $.ajax("/Dormitory/modHealth", {
        type:"post",
        dataType:"json",
        data:{id:id,dormId:dormId,dormName:dormName,dormHealth:dormHealth,createTime:createTime,updateTime:updateTime},
        // 请求成功后的回调函数。
        success :function(data){
            //重新获取当前页
            setPage(num);
...
function setBody(health) {
    ...
    var item = "<tr id=\""+health['id']+"\">"+
        "<td>"+health['id']+"</td>"+
        "<td>"+health['dormId']+"</td>"+
        "<td>"+health['dormName']+"</td>"+
        "<td>"+health['dormHealth']+"</td>"+
