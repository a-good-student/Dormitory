...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/dormHealth.css">
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/js/dormHealth.js"></script>
    <script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/js/json2.js"></script>
    <title>dormHealth</title>
    <style type="text/css">
...
<body>
    ...
    <div class="addContain" id="addContain">
        <div class="addWrapper" id="addWrapper">
            ...
            <div><span>宿舍楼：</span><div><input type="text" class="health" placeholder="请输入宿舍楼"></div></div>
            <div><span>宿舍卫生：</span><div><input type="text" class="health" placeholder="请输入评分0~10"></div></div>
    ...
    <div class="addContain modContain" id="modContain">
        <div class="addWrapper" id="modWrapper">
            ...
            <div><span>宿舍卫生</span><div><input type="text" class="mod"></div></div>
